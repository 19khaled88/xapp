...
async function get_financialStatement(inv_id, dateFrom, dateTo){
    // console.log(inv_id)
    const url = `${baseUrl}japi.ashx?type=get_financialStatement&inv_id=${inv_id}&comp_id=${cid}&fromDate=${dateFrom}&toDate=${dateTo}`
    return await fetchDataByUrl(url)
}